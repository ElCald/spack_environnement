...
Il suffit d'activer l'environnement comme vu au début et de `spack load <package>` pour les packages nécéssaires. De même ces commandes doivent être faite dans le fichier de soumission. <br>
